package com.telemedicine.activity.dokter;
...
import com.telemedicine.activity.pasien.ListAdminActivity;
import com.telemedicine.activity.pasien.ListDokterActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAdapter.setUserListener(new UserAdapter.UserListener() {
            ...
            public void onClickUser(int id) {
                startActivity(new Intent(DokterActivity.this, ChatActivity.class).putExtra("receiver",id));
            }
        });
    ...
    private void getChat(){
        ...
        chatCall.enqueue(new Callback<List<User>>() {
            ...
            public void onFailure(Call<List<User>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(DokterActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
